...
class Customer extends Person
{
    ...
    */
    ...
    $exclude_sale_id: leave out one sale (used when re-completing an existing
    sale, whose payments are already in the DB and would otherwise be counted).
    */
    public function get_stats($customer_id, $exclude_sale_id = -1)
    {
        ...
        if ((int)$exclude_sale_id > 0) {
            $this->db->where('sales.sale_id !=', (int)$exclude_sale_id);
        }
